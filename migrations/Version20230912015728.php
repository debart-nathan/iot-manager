 ...
 */
final class Version20230912015728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE module (module_id INT AUTO_INCREMENT NOT NULL, module_type_name VARCHAR(255) DEFAULT NULL, status_name VARCHAR(255) DEFAULT NULL, module_name VARCHAR(255) NOT NULL, reference_code VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, activation_date DATETIME NOT NULL, status_message VARCHAR(255) NOT NULL, INDEX IDX_C242628D34DA4C6 (module_type_name), INDEX IDX_C2426286625D392 (status_name), PRIMARY KEY(module_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE module_type (module_type_name VARCHAR(255) NOT NULL, picture_file VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(module_type_name)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE module_type_value (module_type_value_id INT AUTO_INCREMENT NOT NULL, module_type_name VARCHAR(255) DEFAULT NULL, value_type_name VARCHAR(255) DEFAULT NULL, INDEX IDX_869EF45ED34DA4C6 (module_type_name), INDEX IDX_869EF45ECCBEBEB8 (value_type_name), PRIMARY KEY(module_type_value_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
